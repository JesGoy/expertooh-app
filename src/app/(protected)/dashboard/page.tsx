...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-950 dark:to-neutral-900">
      <header className="sticky top-0 z-10 border-b border-neutral-200/60 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 backdrop-blur">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={k.label} className="rounded-2xl border border-neutral-200/60 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 backdrop-blur p-4">
        ...
        <section className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 rounded-2xl border border-neutral-200/60 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 backdrop-blur p-4">
          ...
          <div className="rounded-2xl border border-neutral-200/60 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 backdrop-blur p-4">
            <h2 className="text-sm font-medium text-ink mb-3">Reportes recientes</h2>
            <ul className="space-y-2 text-sm">
              <li className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300">Campaña Lima Centro</span>
                <span className="text-xs text-neutral-500">hoy</span>
              </li>
              <li className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300">Awareness Q3 - Retail</span>
                <span className="text-xs text-neutral-500">ayer</span>
              </li>
              <li className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300">Performance OOH - Sur</span>
